            ...
            {step < 4 && (
                <div className="bp-stepper">
                    <div className="bp-step-item">
                        <div className={`bp-step-circle ${step === 1 ? 'active' : ''} ${step > 1 ? 'done' : ''}`}>1</div>
                        <span className={step === 1 ? 'active' : ''}>Empresa</span>
                    </div>
                    <div className={`bp-step-line ${step > 1 ? 'done' : ''}`}></div>

                    <div className="bp-step-item">
                        <div className={`bp-step-circle ${step === 2 ? 'active' : ''} ${step > 2 ? 'done' : ''}`}>2</div>
                        <span className={step === 2 ? 'active' : ''}>Rubro y Ubicación</span>
                    </div>
                    <div className={`bp-step-line ${step > 2 ? 'done' : ''}`}></div>

                    <div className="bp-step-item">
                        <div className={`bp-step-circle ${step === 3 ? 'active' : ''}`}>3</div>
                        ...
                        <>
                            ...
                            <div className="bp-form-actions">
                                <button
                                    className="btn-next"
                                    onClick={() => setStep(2)}
                                    disabled={!formData.businessName || !formData.ownerName || !formData.email || !formData.phone}
                                >
                                    Continuar →
                                </button>
                            </div>
                        ...
                        <>
                            ...
                            <div className="bp-form-actions">
                                ...
                                <button
                                    ...
                                    disabled={loading || !formData.experienceName || !formData.experienceDescription || !formData.minPrice || !formData.maxPrice}
                                >
