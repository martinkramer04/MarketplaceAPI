                ...
                <div className="payment-left">
                    ...
                    {paymentMethod === 'card' && (
                        <div className="payment-form">
                            <div className="payment-campo">
                                ...
                                <input type="text" name="holderName" value={cardForm.holderName} onChange={handleInputChange} placeholder="Nombre en la tarjeta" />
                            </div>
                            <div className="payment-campo">
                                <label>Numero de la tarjeta</label>
                                <input type="text" name="cardNumber" maxLength="19" value={cardForm.cardNumber} onChange={handleInputChange} placeholder="0000 0000 0000 0000" />
                            </div>
                            <div className="payment-campo-row">
                                <div className="payment-campo">
                                    <label>Fecha de vencimiento</label>
                                    <input type="text" name="expiry" maxLength="5" value={cardForm.expiry} onChange={handleInputChange} placeholder="MM/AA" />
                                </div>
                                <div className="payment-campo">
                                    <label>CVV</label>
                                    <input type="password" name="cvv" maxLength="4" value={cardForm.cvv} onChange={handleInputChange} placeholder="..." />
                                </div>
                            </div>
                            <div className="payment-campo">
                                <label>Direccion</label>
                                <input type="text" name="address" value={cardForm.address} onChange={handleInputChange} placeholder="Mismo que el envio" />
                            </div>
                        </div>
                    )}
                    ...
                    {paymentMethod === 'mercadopago' && (
                        <div className="payment-alternative">
                            <p>Seras redirigido a MercadoPago / PayPal para completar el pago de forma segura.</p>
                        </div>
                    )}
                    ...
                    {paymentMethod === 'transfer' && (
                        <div className="payment-alternative">
                            ...
                            <p>Una vez acreditada la transferencia recibiras la confirmacion por email.</p>
                        </div>
                    )}
                    ...
                    footer={({ total }) => (
                        <>
                            ...
                            <p className="pay-terms">
                                Al confirmar aceptas los Terminos de servicio y la Politica de privacidad de BigBox.
                            </p>
                        </>
                    )}
                />
